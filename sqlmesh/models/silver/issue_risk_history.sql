-- The harmonized silver.issue_risk_history: for every issue, the periods during which its
-- state, its effort and its component's safety classification and owning team all stayed
-- the same. Built by silver/project_{a,b}/issue_risk_history.sql with @temporal_join.
--
