...
Two things an administrator changes about the platform rather than about the data in it:
which tenants exist, and which version of the analytics models runs. They share a section
in the admin because they share that character, and neither belongs on the documentation
pages, which are open from the viewer rank up.
