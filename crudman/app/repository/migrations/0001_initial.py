# Generated by Django 6.0.6 on 2026-09-05 19:03
...
def grant_to_engine(apps, schema_editor):
    ...
    schema_editor.execute(
        f"GRANT SELECT, UPDATE ON repository_deployment TO {schema_editor.quote_name(role)}"
    )
...
def revoke_from_engine(apps, schema_editor):
    role = os.environ.get("SQLMESH_DB_USER", "sqlmesh")
    schema_editor.execute(
        f"REVOKE SELECT, UPDATE ON repository_deployment FROM {schema_editor.quote_name(role)}"
    )
