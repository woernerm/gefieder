...
def error_logging_probe(request):
    ...
    and a real deployment does not. It exists because the thing worth asserting -- that an
    unhandled exception is written to the stream journald captures -- is a property of the
    running server process, and only a real request reaches that process.
    """
